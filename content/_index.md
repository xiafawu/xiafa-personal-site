+++
title = "Home"
description = "Personal website - Introduction and research"
template = "index.html"
+++
        ...
        <li class="project-item">
            <div class="project-header">
                <h3 class="project-title">
                    <a href="https://dl.acm.org/doi/10.1109/ICSE55347.2025.00127">GenC2Rust</a>
                </h3>
                <span class="project-year">2024</span>
            </div>
            <p class="project-description">A translation framework that converts C code with void* pointers into idiomatic Rust generics. Published at ICSE 2025.</p>
            <a href="https://zenodo.org/records/15009030" class="project-link">Artifact →</a>
        </li>
        <li class="project-item">
            <div class="project-header">
                <h3 class="project-title">
